...
namespace BH.Engine.LifeCycleAssessment
{
    ...
    public static partial class Query
    {
        ...
        [PreviousVersion("4.1", "BH.Engine.LifeCycleAssessment.Query.GetEvaluationValue(BH.oM.Dimensional.IElementM, BH.oM.LifeCycleAssessment.EnvironmentalProductDeclarationField)")]
        [PreviousVersion("4.1", "BH.Engine.LifeCycleAssessment.Query.GetEvaluationValue(BH.oM.Base.IBHoMObject, BH.oM.LifeCycleAssessment.EnvironmentalProductDeclarationField)")]
