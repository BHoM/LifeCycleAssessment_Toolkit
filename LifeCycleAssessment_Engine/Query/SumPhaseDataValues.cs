...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Query
    {
        ...
        [Input("onlyIncludeIfAllAvailable", "If true, only sums up values for a particular module if it is available on all items provided. If ")]
        ...
        public static Dictionary<Module, double> SumModuleDataValues(this IReadOnlyList<ILifeCycleAssessmentModuleData<IDictionary<Module, double>>> results, bool onlyIncludeIfAllAvailable = false)
        {
