...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Query
    {
        ...
        public static List<IEnvironmentalMetric> FilteredFactors(this EnvironmentalProductDeclaration epd, List<MetricType> metricFilter = null)
        {
            if(epd == null) 
            {
                BH.Engine.Base.Compute.RecordError($"Cannot extract null metrics from a null {nameof(EnvironmentalProductDeclaration)}.");
