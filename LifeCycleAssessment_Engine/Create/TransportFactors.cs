...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Create
    {
        ...
        public static ITransportFactors TransportFactors(TransportMethodology methodology, FullTransportScenario typicalScenario = null, VehicleEmissions vehicleEmissions = null, double distanceTraveled = double.NaN, double customFactor = double.NaN)
        {
            switch (methodology)
            {
                case TransportMethodology.DistanceTransportMode:
                    return DistanceTransportMode(vehicleEmissions, distanceTraveled);
        ...
        private static DistanceTransportModeScenario DistanceTransportMode(VehicleEmissions vehicleEmissions, double distanceTraveled)
        {
