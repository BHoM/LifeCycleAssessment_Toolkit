...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Create
    {
        ...
        [Description("Creates a AcidificationMetric to be applied as part of an EnvironmentalProductDeclaration. Values of A1toA3, B1toB7 and C1toC4 will be computed as the sum of the relevant phases.")]
        ...
        [InputFromProperty("d")]
        [Output("apMetric", "Created AcidificationMetric.")]
        ...
        [Description("Creates a AcidificationMetric to be applied as part of an EnvironmentalProductDeclaration. Create method to be used when no discrete values for A1, A2 and A3 are available, but only a total value for those 3 phases. Values of B1toB7 and C1toC4 will be computed as the sum of the relevant phases.")]
        ...
        [Description("Creates a AcidificationMetric to be applied as part of an EnvironmentalProductDeclaration. Create method to be used when no discrete values for the phases in the Product stage (A1 - A3), use stage (B1-B7) or end of life stage (C1-C4) is given, but only the total value for the phases in those stages are available.")]
        [InputFromProperty("a1toa3", "A1toA3")]
        [InputFromProperty("a4")]
        [InputFromProperty("a5")]
                ...
                double d = double.NaN)
        {
            ...
            return new AcidificationMetric(double.NaN, double.NaN, double.NaN, a1toa3, a4, a5, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, b1tob7, double.NaN, double.NaN, double.NaN, double.NaN, c1toc4, d);
        }
