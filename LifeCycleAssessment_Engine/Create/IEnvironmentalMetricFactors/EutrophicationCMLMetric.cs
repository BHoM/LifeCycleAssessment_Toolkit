...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Create
    {
        ...
        public static EutrophicationCMLMetric EutrophicationCMLMetric(
            ...
            double d = double.NaN)
        {
            return new EutrophicationCMLMetric() { Indicators = FactorsDictionary(a1, a2, a3, a4, a5, b1, b2, b3, b4, b5, b6, b7, c1, c2, c3, c4, d) };
        }

        /***************************************************/

        [Description("Creates a EutrophicationCMLMetric to be applied as part of an EnvironmentalProductDeclaration. Create method to be used when no discrete values for A1, A2 and A3 are available, but only a total value for those 3 modules. If no values are provided (NaN), the module will not be added to the created metric.")]
        ...
        public static EutrophicationCMLMetric EutrophicationCMLMetric(
                ...
                double d = double.NaN)
        {
            return new EutrophicationCMLMetric() { Indicators = FactorsDictionary(a1toa3, a4, a5, b1, b2, b3, b4, b5, b6, b7, c1, c2, c3, c4, d) };
        }

        /***************************************************/

        [Description("Creates a EutrophicationCMLMetric to be applied as part of an EnvironmentalProductDeclaration. Create method to be used when no discrete values for the modules in the Product stage (A1 - A3), use stage (B1-B7) or end of life stage (C1-C4) is given, but only the total value for the modules in those stages are available. If no values are provided (NaN), the module will not be added to the created metric.")]
        [InputFromDescription("a1toa3", Module.A1toA3, typeof(EutrophicationCMLPerQuantity))]
        [InputFromDescription("a4", Module.A4, typeof(EutrophicationCMLPerQuantity))]
        [InputFromDescription("a5", Module.A5, typeof(EutrophicationCMLPerQuantity))]
                ...
                double d = double.NaN)
        {
            ...
            return new EutrophicationCMLMetric() { Indicators = FactorsDictionary(a1toa3, a4, a5, b1tob7, c1toc4, d) };
        }
