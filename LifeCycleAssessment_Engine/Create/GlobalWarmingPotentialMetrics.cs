...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Create
    {
        ...
        [Description("Creates a GlobalWarmingPotentialMetrics to be applied as part of an EnvironmentalProductDeclaration. Value of A1toA3 will be computed based on provided A1, A2 and A3 values.")]
