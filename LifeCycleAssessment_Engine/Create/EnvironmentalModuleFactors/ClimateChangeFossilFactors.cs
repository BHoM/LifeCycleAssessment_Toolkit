...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Create
    {
        ...
        public static EnvironmentalMetricFactors<ClimateChangeFossilFactor> ClimateChangeFossilFactors(
            ...
            double d = double.NaN)
        {
            return Create.EnvironmentalMetricFactors<ClimateChangeFossilFactor>(oM.LifeCycleAssessment.MetricType.ClimateChangeFossil, a1, a2, a3, a4, a5, b1, b2, b3, b4, b5, b6, b7, c1, c2, c3, c4, d);
        }
        ...
        public static EnvironmentalMetricFactors<ClimateChangeFossilFactor> ClimateChangeFossilFactors(
                ...
                double d = double.NaN)
        {
            return Create.EnvironmentalMetricFactors<ClimateChangeFossilFactor>(oM.LifeCycleAssessment.MetricType.ClimateChangeFossil, a1toa3, a4, a5, b1, b2, b3, b4, b5, b6, b7, c1, c2, c3, c4, d);
        }
                ...
                double d = double.NaN)
        {
            ...
            return Create.EnvironmentalMetricFactors<ClimateChangeFossilFactor>(oM.LifeCycleAssessment.MetricType.ClimateChangeFossil, a1toa3, a4, a5, b1tob7, c1toc4, d);
        }
