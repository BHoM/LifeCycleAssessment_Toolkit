...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Create
    {
        ...
        public static ClimateChangeFossilMetric ClimateChangeFossilMetric(
            ...
            double d = double.NaN)
        {
            return new ClimateChangeFossilMetric() { Factors = FactorsDictionary(a1, a2, a3, a4, a5, b1, b2, b3, b4, b5, b6, b7, c1, c2, c3, c4, d) };
        }
        ...
        public static ClimateChangeFossilMetric ClimateChangeFossilMetric(
                ...
                double d = double.NaN)
        {
            return new ClimateChangeFossilMetric() { Factors = FactorsDictionary(a1toa3, a4, a5, b1, b2, b3, b4, b5, b6, b7, c1, c2, c3, c4, d) };
        }
                ...
                double d = double.NaN)
        {
            ...
            return new ClimateChangeFossilMetric() { Factors = FactorsDictionary(a1toa3, a4, a5, b1tob7, c1toc4, d) };
        }
