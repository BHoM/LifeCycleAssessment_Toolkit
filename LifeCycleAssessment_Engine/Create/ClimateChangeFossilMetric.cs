...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Create
    {
            ...
            double d = double.NaN)
        {
            ...
            return new ClimateChangeFossilMetric(a1, a2, a3, a1toa3, a4, a5, b1, b2, b3, b4, b5, b6, b7, b1tob7, c1, c2, c3, c4, c1toc4, d);
        }
                ...
                double d = double.NaN)
        {
            double b1tob7 = b1 + b2 + b3 + b4 + b5 + b6 + b7;
            double c1toc4 = c1 + c2 + c3 + c4;
            return new ClimateChangeFossilMetric(double.NaN, double.NaN, double.NaN, a1toa3, a4, a5, b1, b2, b3, b4, b5, b6, b7, b1tob7, c1, c2, c3, c4, c1toc4, d);
        }
                ...
                double d = double.NaN)
        {
            ...
            return new ClimateChangeFossilMetric(double.NaN, double.NaN, double.NaN, a1toa3, a4, a5, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, double.NaN, b1tob7, double.NaN, double.NaN, double.NaN, double.NaN, c1toc4, d);
        }
