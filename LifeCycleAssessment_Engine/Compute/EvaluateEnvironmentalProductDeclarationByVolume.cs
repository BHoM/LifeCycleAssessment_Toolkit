...
namespace BH.Engine.LifeCycleAssessment
{
    public static partial class Compute
    {
        ...
        public static GlobalWarmingPotentialResult EvaluateEnvironmentalProductDeclarationByVolume(IElementM obj = null, EnvironmentalProductDeclarationField field = EnvironmentalProductDeclarationField.GlobalWarmingPotential)
        {
            if (obj.QuantityType() != QuantityType.Volume)
            {
            ...
            else
            {
                ...
                if (volume <= 0)
                {
                    BH.Engine.Reflection.Compute.RecordError("Volume cannot be calculated from object " + ((IBHoMObject)obj).BHoM_Guid);
                    return null;
                }
