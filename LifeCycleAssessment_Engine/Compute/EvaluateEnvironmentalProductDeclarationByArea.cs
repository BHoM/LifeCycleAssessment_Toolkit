    ...
    public static partial class Compute
    {
        ...
        private static EnvironmentalMetricResult EvaluateEnvironmentalProductDeclarationByArea(IElementM elementM, List<LifeCycleAssessmentPhases> phases, MaterialComposition materialComposition, EnvironmentalProductDeclarationField field = EnvironmentalProductDeclarationField.GlobalWarmingPotential, bool exactMatch = false)
        {
            if (elementM is IElement2D)
            {
                ...
                List<double> epdVal = elementM.GetEvaluationValue(field, phases, QuantityType.Area, materialComposition, exactMatch);
