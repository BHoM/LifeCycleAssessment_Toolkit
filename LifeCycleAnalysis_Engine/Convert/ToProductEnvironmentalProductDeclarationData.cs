...
namespace BH.Engine.LifeCycleAnalysis
{
    public static partial class Convert
    {
        ...
        public static ProductEnvironmentalProductDeclaration ToEnvironmentalProductDeclarationData(this CustomObject obj)
        {
            ProductEnvironmentalProductDeclaration epd = new ProductEnvironmentalProductDeclaration
            {
